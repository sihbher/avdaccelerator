...
| `Managed-Identity-Wait-{uniqueString}` | Deployment script (Zero Trust) | Introduce wait time after managed identity creation. |
...
| `AVD-managementVmWait-{uniqueString}` | Deployment script | Introduce wait time after management VM creation. |
...
| `Antimalware-Extension-Wait-{uniqueString}` | Deployment script | Introduce wait time after antimalware extension configuration. |
| `Session-Hosts-Wait-{uniqueString}` | Deployment script | Introduce wait time after session host creation. |
| `SH-Monitoring-Wait-{uniqueString}` | Deployment script | Introduce wait time after session monitoring agent. |
...
| `Managed-Identity-Wait-{uniqueString}` | Deployment script | Introduce wait time after managed identity creation. |
...
| `Log-Analytics-Workspace-Wait-{uniqueString}` | Deployment Script | Introduce wait time after log analytics workspace creation. |
